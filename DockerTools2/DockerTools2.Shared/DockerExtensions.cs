...
namespace DockerTools2.Shared
{
    public static class DockerExtensions
    {
        ...
        public static Task<CommandLineClientResult> GetDockerContainerIdAsync(this ICommandLineClient client, string containerName, CancellationToken cancellationToken = default(CancellationToken))
        {
