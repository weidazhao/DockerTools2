...
{
    public class DockerSignature : ISignature
    {
        private string _propertyName;
        private string _syntax;
        private string _description;
        private string _content;
        private DockerKeywordParameter _nameParam;
        ...
        public DockerSignature(string keyword, string syntax, string description, ITrackingSpan trackingSpan, ISignatureHelpSession session)
        {
            ...
            _nameParam = new DockerKeywordParameter(this);
    ...
    internal class DockerKeywordParameter : IParameter
    {
        private DockerSignature _signature;

        public DockerKeywordParameter(DockerSignature signature)
        {
